...
public class LteParameterSelfAdaptionOptimizationResource {
    ...
    public List<LteParameterSelfAdaptionOptimizationDTO> queryImport(LteParameterSelfAdaptionOptimizationVM vm) throws ParseException {
        System.out.println(vm.toString());
        if("440103".equals(vm.getDistrict()) ){
                return lteParameterSelfAdaptionOptimizationService.queryAllTargetCells("广州荔湾区","摩星岭站");
        }
