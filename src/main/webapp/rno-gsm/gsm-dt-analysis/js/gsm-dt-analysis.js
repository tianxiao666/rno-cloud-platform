...
var strenth1=0,strenth2=0,strenth3=0,strenth4=0,strenth5=0,strenth6=0,strenth7=0,strenth8=0,strenth9=0;
...
function showDtAnalysisResult(type) {
    ...
    if(type === "strenth") {
        $("#showRxlev").show();
        strenth1=0;strenth2=0;strenth3=0;strenth4=0;strenth5=0;strenth6=0;strenth7=0;strenth8=0,strenth9=0;
    }else if(type === "quality"){
        $("#showQuality").show();
        quality1=0;quality2=0;quality3=0;quality4=0;quality5=0;
...
function showResultTable(type) {
    ...
    if(type === "strenth") {
        ...
        strenthArray.push(strenth1);strenthArray.push(strenth2);strenthArray.push(strenth3);strenthArray.push(strenth4);
        strenthArray.push(strenth5);strenthArray.push(strenth6);strenthArray.push(strenth7);strenthArray.push(strenth8);
        strenthArray.push(strenth9);
        var strenthCount = new Array();
        strenthCount.push(mathPercent(strenth1,total));strenthCount.push(mathPercent(strenth2,total));
        strenthCount.push(mathPercent(strenth3,total));strenthCount.push(mathPercent(strenth4,total));
        strenthCount.push(mathPercent(strenth5,total));strenthCount.push(mathPercent(strenth6,total));
        strenthCount.push(mathPercent(strenth7,total));strenthCount.push(mathPercent(strenth8,total));
        ...
        qualityArray.push(quality1);qualityArray.push(quality2);qualityArray.push(quality3);qualityArray.push(quality4);
        qualityArray.push(quality5);
        var qualityCount = new Array();
        qualityCount.push(mathPercent(quality1,tot));qualityCount.push(mathPercent(quality2,tot));
        qualityCount.push(mathPercent(quality3,tot));qualityCount.push(mathPercent(quality4,tot));
