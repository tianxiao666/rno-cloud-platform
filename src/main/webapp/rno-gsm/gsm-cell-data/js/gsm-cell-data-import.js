...
function bindEvent(){
	...
	$("#importBtn").click(function() {
		...
		var fileCode=$("input[name='fileStyle']:checked").val();
		...
		$("#err").remove();
		if ($("#fileid").val() == "") {
			$("#fileid").parent().append("<font id='err' color='red'>请选择文件</font>");
			return;
		}
		/*if ($.trim($("#meatime").val()) == "") {
...
//	
	...
	//console.log("fileStyle:" +fileStyle +"fileStatus:"+fileStatus +"cityId:"+cityId +"begUploadDate:" +begUploadDate+"endUploadDate:"+endUploadDate);
	$("#searchImportForm").ajaxSubmit({
		url:'queryUploadRecAjaxAction',
		data:{'fileCode' : fileStyle,
